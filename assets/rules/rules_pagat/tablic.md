...
**Difficulté :** —
**Type :** Pêche, Pêche
**But :** Which is popular in Serbia and other countries of the former Yugoslavia.
...
Tablić is played with a standard 52-card deck without jokers. For the purpose of capture the cards have values: king=14, queen=13, jack=12, ace=1 or 11 at the choice of the player, other cards face value. The suits have no significance in this game, except that the ![diamond](../images/internat/diamond.gif)10 and ![club](../images/internat/club.gif)2 are worth extra points in the scoring.
...
A [Tablić / Tablanet computer program](https://thanoscardgames.jimdofree.com/download/fishing/tablic) is available from Thanos Cardgames.

Rules in Serbian are available on the [ADUT forum](https://kartanje.serbianforum.info) (registration required).

The site igrajkarte.com had [rules of Tablić](https://web.archive.org/web/20251114143943/https://www.igrajkarte.com/blog/post/tablic-pravila/) (archive copy).
