...
**Difficulté :** —
**Type :** Divers, Divers
**But :** A Canadian card game for four players in partnerships, in which the aim is to win tricks containing Aces, Tens and Fives.
...
Other scoring variations - Number of cards - Minimum bid - No Trump Contract - Compulsory trump lead
- Deal variations and "Misdeal" - Six-player game - 200 with a pot - Le Rough - Five player game - Two player game
...
Some play with hands of 10 cards each - so all the cards down to 5are used for the game without a kitty (40 cards), and if playing with a kitty the 4's are included as well (44 cards). Denis Landry reports that the 10-card game (without a kitty) is more usual in South-East New Brunswick. In North-East New Brunswick, 200 is usually played with 9-card hands (36 or 40 cards).
...
On Facebook, Amélie Aubut has published the [rules of Le Dix](https://www.facebook.com/notes/dix/r%C3%A8gles-du-jeu-en-acadien/56032706229) in Acadian French.

The Ange Hereux site has rules in French for [Le Rough](http://www.ange.heureux.free.fr/Jeux/LeRough.html).

Here is an archive copy of a description of [La Barouche](https://web.archive.org/web/20210425141340/https://www.learnmichif.com/games/la-barouche) in English by Stella Johnson and Francis Fisher.
