...
**Difficulté :** —
**Type :** Rami, Rami
**But :** A rummy game played in the Philippines with 12-card hands, possibly related to the American game Tonk.
...
A run consists of three or more consecutive cards of the same suit, such as ![heart](../images/internat/heart.gif)4, ![heart](../images/internat/heart.gif)5, ![heart](../images/internat/heart.gif)6 or ![spade](../images/internat/spade.gif)8, ![spade](../images/internat/spade.gif)9, ![spade](../images/internat/spade.gif)10, ![spade](../images/internat/spade.gif)J. (A-K-Q of a suit is not a run since aces are low in this game).

A set consists of three or four cards of the same rank, such as ![heart](../images/internat/heart.gif)7, ![club](../images/internat/club.gif)7, ![diamond](../images/internat/diamond.gif)7. A card can belong to only one combination at a time - you cannot use the same card as part of both a set and a run.
...
Home Page > Classified Index > Draw and Discard Games > Rummy Games > Tong Its
