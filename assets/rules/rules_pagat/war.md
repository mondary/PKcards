...
**But :** And whoever has the higher card wins both of them.
...
Günther Senst played this simple variant as a child in Mecklenburg, Germany. In this game the players play through the deck once only: the cards are not recycled.
...
This archive copy of the [ Casino War Guide at thepogg.com](https://web.archive.org/web/20230406104749/https://thepogg.com/guides/casino-war/) provides information on Casino War and its strategy.

## Software and On Line Games

The collection 
HOYLE Card Games for Windows or Mac OS X includes a War program, along with many other popular card games. 

You can play War online at [Bloob.io](https://bloob.io/).

Home Page > Classified Index > War group > War
