...
**But :** A popular Afghan partnership card game for four players with an auction in which the player who promises that their team will win most tricks chooses the trump suit.
...
- a number from "8" to "13", offering to make trumps and committing the team to win at least that number of tricks;

- "double 13", offering to make trumps and win all 13 tricks, playing alone;

- "pass" or "*ter*" (meaning "through") or "*behi ter*" (meaning "completely through"), if the player does not want to make trumps.
...
Home Page > Classified Index > Trick Taking Games > Auction Whist Group > Teka
