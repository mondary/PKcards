...
**Difficulté :** ⭐⭐⭐
**Type :** Tarot, Tarot
**But :** One of the most popular card games in France, played with a 78-card pack.

---

## Introduction

Games are played with Tarot cards in various countries of Europe, but nowhere is it as popular as in France. There are clubs, tournaments (including duplicate events) and an official body, the [Fédération Française de Tarot](https://fftarot.fr/). French Tarot is also played in the French speaking parts of Canada. The following description is partly based on contributions from Craig Kaplan, Michel Braunwarth and Eric Betito.
...
![petit](../images/tarot/t1.gif) ![21](../images/tarot/t21.gif) ![excuse](../images/tarot/ex.gif)
...
**Garde sans le chien** (Guard without the kitty) No one looks at the chien, but the card points in it count as part of the taker's tricks.
**Garde contre le chien** (Guard against the kitty) No one looks at the chien and it is counted as part of the tricks of the opponents of the taker.
...
This is a bonus which occurs if the 1 of trump is played in the last trick. In this
case the team that takes the last trick wins the bonus (10 points).
...
**misère** - a bonus if you have no trumps or no court cards, worth 10 points
**petit chelem** - a bonus for making nearly all the tricks - all except one or all except three, as agreed by the players
...
The deal is as follows: three cards one by one to your opponent, face down, side by side; then three cards to yourself, similarly; then three more to your opponent alongside the first three
cards and three more to yourself. At this point there is a row of six cards face down in front of each player. Now repeat the process, dealing the new cards on top of the old ones, so that each player has six face-down piles of two cards. Then do the same again, but dealing the cards face up on top of the piles, so that each player has six piles of three cards with a face up card on top. The remaining cards are dealt out three at a time to the two players, so that each has a hand of 21 cards.
...
Here is the web page of the official Tarot organisation in France: [La Fédération Française de Tarot](https://fftarot.fr/).

François Constantineau's French language site [La page tarot de Shogix](https://www.shogix.net) contains example deals, analysis, problems and a glossary.

Jean-François Bustarret's [Tarot](https://web.archive.org/web/20250401025911/https://www.jeuxdecartes.net/jeux-cartes/tarot/) page (archive copy) had rules in French.

Fabrice's web site (in French) includes a section on [Tarot](http://popeye.perso.infonie.fr/menus/tarot.htm) with rules, strategies, on-line tournaments and a section in which a game of Tarot is played at the rate of one card every 2 or 3 days, with discussion on the best play at each stage.

Here is an archive copy of Sylvain Lhullier's page [règles du jeu de tarot](https://web.archive.org/web/20030402041513/www.bric-a-brac.org/tarot/regles.html), which unfortunately began with two historical errors: that playing-cards arrived in Europe in the 10th century, and that the earliest European cards were Tarot cards.

V & V Beuselinck's [Taroscopie](https://www.beuselinck.fr/spip.php?page=rubrique&id_rubrique=10) site contains an electronic book of Tarot rules, strategy and organisation of clubs and tournaments, which can be viewed on-line or downloaded.

[Matt's web site on Tarot Conventions](http://matt.78.free.fr/) discusses some limitations of the FFT system and proposes an alternative, and includes a quantity of examples and discussion.

## French Tarot Software and Online Games

At GameDuell you can play [Tarot](https://www.kqzyfj.com/click-4373756-11122159) online against live opponents.

You can also play Tarot online against live opponents at [VIP Tarot](https://viptarot.fr/en/).

You can play Tarot online at [TRADiGAMES](https://www.tradigames.com/en).

The [Tarot Pro](https://www.recreasoft.net/logiciels.php) computer program is available from Recreasoft.

Here is a link to the web site for [Jean-Pierre Grillon's Tarot program](https://www.webtarot.fr).

François Uhrich has written a [Tarot program](https://www.letarot.net) for the Macintosh.

At the [Ludiclub](https://www.ludi.com/jeux/jeux-de-cartes.aspx) site you can play Tarot on line. 

A multiplayer online Tarot game is available at [exoty.com](https://exoty.com/en/?lang=en).

Board Game Arena offers an [online French Tarot](https://boardgamearena.com/#!gamepanel?game=frenchtarot) game.

The free computer program [FoxTarot](https://foxtarot.com/) by Fabrice Renard can be used to play against the computer or on line against other players.

At Pierre-Marie Petit's [Jeutarot](https://www.jeutarot.com) site you can play Tarot tournament deals on line.

With the free computer program [Tarobot](https://tarobot.fr.softonic.com/), written by Vincent Pelletier of Quebec, you can play 3-, 4- or 5-player Tarot against the computer.

Sylvain Labbe's [Free Card Games](https://labbe.pagat.com/) includes Net.Tarot, an online French Tarot program for play against live opponents. It can be used both on desktop computers and on mobile devices of several types.

Home Page > Classified Index > Trick Taking Games > Tarot Games > Tarot (French)
