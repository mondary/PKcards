...
**Difficulté :** ⭐⭐⭐
**Type :** Divers, Divers
**But :** A Chinese double deck card game for four players in which the aim is to win Kings, Tens and Fives, and groups of cards can be played together.
...
For example, if sevens and clubs are trumps, the trumps from high to low are: red joker, black joker, ![club](../images/internat/club.gif)7, other sevens (equal in rank), ![club](../images/internat/club.gif)A, ![club](../images/internat/club.gif)K, ![club](../images/internat/club.gif)Q, ![club](../images/internat/club.gif)J, ![club](../images/internat/club.gif)10, ![club](../images/internat/club.gif)9, ![club](../images/internat/club.gif)8, ![club](../images/internat/club.gif)6, ![club](../images/internat/club.gif)5, ![club](../images/internat/club.gif)4, ![club](../images/internat/club.gif)3, ![club](../images/internat/club.gif)2.
...
- The ![heart](../images/internat/heart.gif)5 is led. This is a trump, so each of the other players must play a diamond, a five or a joker if possible. If the cards played to the trick are ![heart](../images/internat/heart.gif)5, ![diamond](../images/internat/diamond.gif)Q, ![diamond](../images/internat/diamond.gif)10 and ![spade](../images/internat/spade.gif)5 in that order, the player of the ![heart](../images/internat/heart.gif)5 wins the trick, since this was played before the equally high ![spade](../images/internat/spade.gif)5.

- The ![heart](../images/internat/heart.gif)7 is led. This is not a trump, so the other players must play hearts (other than the five) if they can. If your only heart is the five, you may play it on this trick, but you are not obliged to; you are unable to follow suit with a non-trump heart, so you may play any card. If the cards played to the trick are ![heart](../images/internat/heart.gif)7, ![spade](../images/internat/spade.gif)J, ![spade](../images/internat/spade.gif)J, ![heart](../images/internat/heart.gif)10, the ten wins, since it is the highest heart that was played.

2. Leading a pair of identical cards
Any pair of identical cards can be led, but note that they do have to be identical, not just equal. For example if nines and spades are trumps, you can lead ![diamond](../images/internat/diamond.gif)9-![diamond](../images/internat/diamond.gif)9, but ![heart](../images/internat/heart.gif)9-![club](../images/internat/club.gif)9 would not be a legal lead.
...
When an identical pair of non trumps is led, anyone who has a pair of identical cards in the same suit must play such a pair. Those who have no such pair can play any two cards of the suit led. If they only have one card of the suit led, they play that together with any other card. A player who has no cards of the suit led can play any two cards - there is no obligation to play a pair in this case. The trick is won by whoever plays the highest identical pair in the suit led, unless some other player, having no cards of that suit, trumps the trick with a pair of identical trumps. If a pair of identical trumps is played to the trick, the highest pair of identical trumps wins. If two players were to play equally high pairs of trumps - for example ![heart](../images/internat/heart.gif)9-![heart](../images/internat/heart.gif)9 and ![diamond](../images/internat/diamond.gif)9-![diamond](../images/internat/diamond.gif)9 when nines and spades are trumps - then the first played of these pairs would beat the other. It is not possible to win the trick with two unpaired trumps.
Examples. Suppose that threes and hearts are trumps.

- North leads ![club](../images/internat/club.gif)J-![club](../images/internat/club.gif)J; West has no club pair and plays ![club](../images/internat/club.gif)A-![club](../images/internat/club.gif)Q; South has only one club and plays ![club](../images/internat/club.gif)4-![spade](../images/internat/spade.gif)10; East, whose clubs are 10, 10, 7, 6, 3, would like to play two worthless low clubs, but must follow with the pair ![club](../images/internat/club.gif)10-![club](../images/internat/club.gif)10. North wins the trick, since West's unpaired clubs cannot beat a pair.

- North leads ![diamond](../images/internat/diamond.gif)5-![diamond](../images/internat/diamond.gif)5, West beats this with ![diamond](../images/internat/diamond.gif)K-![diamond](../images/internat/diamond.gif)K, South, having no clubs, trumps with ![heart](../images/internat/heart.gif)2-![heart](../images/internat/heart.gif)2 and East, who has nothing but trumps, plays ![heart](../images/internat/heart.gif)8-![heart](../images/internat/heart.gif)7. South wins the trick since East's trumps, though higher, are not a pair.
...
- ![club](../images/internat/club.gif)8-![club](../images/internat/club.gif)8-![club](../images/internat/club.gif)9-![club](../images/internat/club.gif)9. Two consectutive pairs are known as a tractor, after which the game is named.

- ![spade](../images/internat/spade.gif)J-![spade](../images/internat/spade.gif)J-![spade](../images/internat/spade.gif)Q-![spade](../images/internat/spade.gif)Q-![spade](../images/internat/spade.gif)K-![spade](../images/internat/spade.gif)K. Three or more consecutive pairs are named after various other vehicles. Unfortunately I do not know what names are used, except that five consecutive pairs are a tank.

- ![heart](../images/internat/heart.gif)3-![heart](../images/internat/heart.gif)3-![heart](../images/internat/heart.gif)5-![heart](../images/internat/heart.gif)5. When fours are trumps, threes and fives become consecutive.
...
- ![heart](../images/internat/heart.gif)4-![heart](../images/internat/heart.gif)4-![diamond](../images/internat/diamond.gif)4-![diamond](../images/internat/diamond.gif)4. These ranks are also adjacent when fours and diamonds are trumps.

- ![diamond](../images/internat/diamond.gif)4-![diamond](../images/internat/diamond.gif)4-[black joker]-[black joker]

- [black joker]-[black joker]-[red joker]-[red joker]

The following would not be valid leads:

- ![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)7-![spade](../images/internat/spade.gif)7. Ranks not adjacent (six missing).

- ![club](../images/internat/club.gif)8-![club](../images/internat/club.gif)8-![heart](../images/internat/heart.gif)9-![heart](../images/internat/heart.gif)9. Different suits.

- ![heart](../images/internat/heart.gif)4-![heart](../images/internat/heart.gif)4-![heart](../images/internat/heart.gif)5-![heart](../images/internat/heart.gif)5. Not adjacent: fours are trumps; fives are not.

- ![diamond](../images/internat/diamond.gif)3-![diamond](../images/internat/diamond.gif)3-![diamond](../images/internat/diamond.gif)4-![diamond](../images/internat/diamond.gif)4. Not adjacent: fours are high trumps; next rank above three is five.

- ![club](../images/internat/club.gif)4-![club](../images/internat/club.gif)4-![spade](../images/internat/spade.gif)4-![spade](../images/internat/spade.gif)4. Ranks are equal, not adjacent.
...
- West leads ![heart](../images/internat/heart.gif)3-![heart](../images/internat/heart.gif)3-![heart](../images/internat/heart.gif)4-![heart](../images/internat/heart.gif)4. South's hearts are J, 10, 10, 8, 6, 5, 5 and South is forced to follow with pairs: ![heart](../images/internat/heart.gif)10-![heart](../images/internat/heart.gif)10-![heart](../images/internat/heart.gif)5-![heart](../images/internat/heart.gif)5. East and North do not have heart pairs and follow with unmatched cards. West wins the trick because South's pairs, though they are higher, are not consecutive.
...
- ![heart](../images/internat/heart.gif)A-![heart](../images/internat/heart.gif)K-![heart](../images/internat/heart.gif)K is a valid lead, since there is only one other heart ace at large so the K-K is unbeatable in hearts.

- If one ace, one king and both jacks of spades have been played, then ![spade](../images/internat/spade.gif)A-![spade](../images/internat/spade.gif)K-![spade](../images/internat/spade.gif)Q-![spade](../images/internat/spade.gif)Q-![spade](../images/internat/spade.gif)10 is a valid lead (there is no outstanding spade to beat the 10).

- If one ace and both kings of diamonds have been played then ![diamond](../images/internat/diamond.gif)A-![diamond](../images/internat/diamond.gif)Q is a valid lead.

- If one ace and one king of hearts have been played, ![heart](../images/internat/heart.gif)A-![heart](../images/internat/heart.gif)Q-![heart](../images/internat/heart.gif)Q-![heart](../images/internat/heart.gif)J is not a valid lead because the jack could be beaten by the outstanding king.
...
- North leads ![club](../images/internat/club.gif)A-![club](../images/internat/club.gif)Q-![club](../images/internat/club.gif)Q, West trumps with ![spade](../images/internat/spade.gif)A-![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)5, South overtrumps with ![spade](../images/internat/spade.gif)2-![spade](../images/internat/spade.gif)7-![spade](../images/internat/spade.gif)7 and East plays three clubs. South wins with the higher trump pair.

- North leads ![club](../images/internat/club.gif)A-![club](../images/internat/club.gif)K-![club](../images/internat/club.gif)Q, West trumps with ![spade](../images/internat/spade.gif)2-![spade](../images/internat/spade.gif)7-![spade](../images/internat/spade.gif)7, South overtrumps with ![spade](../images/internat/spade.gif)A-![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)5 and East plays three clubs. South wins again because the ![spade](../images/internat/spade.gif)A beats the ![spade](../images/internat/spade.gif)7 - pairs are now irrelevant since no pair was led.

- North leads ![club](../images/internat/club.gif)A-![club](../images/internat/club.gif)K, West trumps with ![spade](../images/internat/spade.gif)A-![spade](../images/internat/spade.gif)3, South has no clubs and ![spade](../images/internat/spade.gif)A and ![spade](../images/internat/spade.gif)Q but these two trumps will not beat West's, because only the highest trump is compared, and West's ![spade](../images/internat/spade.gif)A was played first.
...
Some allow a tractor to skip ranks of which all the cards have already been played. For example if no one has any ![spade](../images/internat/spade.gif)6's left then ![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)7-![spade](../images/internat/spade.gif)7 becomes a tractor, and even ![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)5-![spade](../images/internat/spade.gif)9-![spade](../images/internat/spade.gif)9-![spade](../images/internat/spade.gif)J-![spade](../images/internat/spade.gif)J becomes valid if there are no 6's, 7's, 8's or 10's of spades remaining in play.
