...
**But :** A whist-like card game, ususally for three players, consisting of a series of deals in which each player has a quota of tricks to win.
**Autres noms :** Trumf
...
- **Valfri ***(free choice)*, also known as Trumf *(trumps)*: forehand may choose any suit as trumps (clubs, spades, hearts or diamonds) and the aim is to win tricks.
...
The earliest known published rules are by Kortman (pseudonym for Thomas Bennett) in *På tumanhand med Bomans flickor* (Lars Hökerbergs bokförlag, Stockholm, 1944). This has four rounds in the order Forehand Chooses Trump, Turned Trump, *Sans Atout*, and *Nolle*. The deal is three rounds in packets of 5, then one more card to each, then an extra four cards to forehand, all face down. In round 1 forehand looks at all 20 cards privately before choosing the trump suit and discarding four cards face down. In the second round the trump suit is chosen at random by cutting a card from the shuffled deck and then shuffling again (or a second deck could be used if available to determine trumps). In the first two rounds, where there is a trump suit, players unable to follow suit must play a trump if possible. In the last round *Nolle* where the aim is to avoid winning tricks, Aces rank low (below the 2) and Kings are highest in each suit. There is never any obligation to head a trick.
...
Home Page > Classified Index > Trick Taking Games > Whist group > Quota > Bismarck
