...
**But :** Basic rules of Contract Bridge - rubber, duplicate and other variations - plus a listing of Bridge resources on the web.
**Autres noms :** Honeymoon Bridge, Kurnik
...
| Slam bonus | not vulnerable | vulnerable |
| small slam | 500 | 750 |
...
| Score per overtrick | not vulnerable | vulnerable |
| doubled | 100 | 200 |
| redoubled | 200 | 400 |
...
| Dealer | # | Vul | Contract | By | Tricks | Plus | Minus | Plus | Minus |
| N | 1 | - | 4S | S | 10 | 420 |   |   |   |
| E | 2 | NS | 5D* | W | 8 | 500 |   |   |   |
| S | 3 | EW | 3NT | W | 12 |   | 690 |   |   |
| W | 4 | All | 2H | N | 9 | 140 |   |   |   |
...
| Board No. 1 |
| Pair No. | Contract | By | Tricks | North-South | Matchpoints |
| NS | EW | Plus | Minus | NS | EW |
| 1 | 8 | 4S | N | 10 | 420 |   | 5 | 7 |
...
There are several alternative versions of this scoring table. In Estonia, a compensation table is used which also takes into account the fit between the hands of the partners with the majority of high card points. The details are available in this archive copy of Tanel Teinemaa's [Compensation Table](https://web.archive.org/web/20210618120247/http://www.compensationtable.com/table.php).

## The Beer Card

![beer card](../images/internat/7d.gif)
...
Further information about Minibridge can be found on the English Bridge Union's [Minibridge pages](https://www.ebu.co.uk/information-resources/minibridge).

[Abridged](https://amzn.to/2usdV86) is a proprietary game, based on Minibridge.
...
- the World Bridge Federation's [Laws of Duplicate Bridge](https://www.worldbridge.org/regulations/2017-laws-of-duplicate-bridge/) (revised in 2017)

- the [Rubber Bridge Laws](https://cdn.acbl.org/wp-content/uploads/2015/02/Laws-of-Rubber-Bridge.pdf) (2014) as promulgated by the American Contract Bridge League, and

- the [Laws of Online Bridge](https://www.ecatsbridge.com/documents/laws_appeals/online_laws/default.asp) (2001).

The [Bridge World home page](https://www.bridgeworld.com/) has some good introductory material for beginners, as well as problems, a book list, samples from their magazine, and links to other sites. 

The [BridgeHands](https://www.bridgehands.com) site provides an indexed encyclopedia of Bridge terms, summaries of popular bidding systems, a copy of the laws, some book reviewed and other resources.

Bobby Wolff's daily Bridge column [The Aces on Bridge](https://aces.bridgeblogging.com/) is available to read online.

[David Stevenson's Bridge Page](https://www.blakjak.org/brg_menu.htm) has a collection of articles, stories, information and useful links.

The [Bridge Base](https://www.bridgebase.com) site provides articles and educational software and well as an on line Bridge server.

[Bridge 7](https://www.bridge7.com/) provides some free advice and a course of 12 lessons of which the first two are free.

The web site of the [Pattaya Bridge Club](https://www.pattayabridge.com/) in Thailand has a fair amount of Bridge information, including a useful reference section on conventions.

[Ron Klinger Bridge](https://www.ronklingerbridge.com/), the web site of the well-known Australian player, provides news, problems, advice and other resources.

Jason Feldman and Gavin Wolpert's [Bridge Winners](https://bridgewinners.com/) site features Bridge articles, problems and polls, tournament news, an ACBL convention card editor and a social networking framework.

The [Bridge Today University](https://www.bridgetoday.com) provides Bridge lessons by e-mail.

[Warren's Free Bridge Workshop](http://members.dslextreme.com/users/whvh520/) offers instruction based on "Standard-American Goren Party Bridge" techniques.

This archive copy of Zar Petkov's former [Zar Points](https://web.archive.org/web/20080926003118/http://www.zarpoints.com/) web site explains his hand evaluation method and the theory behind it. It included a calculator which compared valuations of pairs of hands using the Zar, Bergen and Goren point counts.
...
The [Bridge 7](https://www.bridge7.com) site offers Bridge tutorials and software in English and in Turkish.

The [Bridge Doctor](https://www.bridgedoctor.com) site, run by New Zealand players Graeme Tuffnell and Tina McVeigh, provides on line Bridge tutorials and games.

An [introduction to Rubber Bridge](https://cardgameheaven.com/bridge) is available at the Card Game Heaven web site.

[LeBridge.info](https://www.lebridge.info) is a French language website offering an introduction to Bridge for beginners.

### Bridge Discussion

All aspects of Bridge are discussed in the newsgroup rec.games.bridge which can be accessed using newsreader software or through web interfaces such as [Google](https://groups.google.com/g/rec.games.bridge).

### Sites for playing Bridge online

- [OKBridge](https://www.okbridge.com/?assoc=73)

- [Bridge Base](https://www.bridgebase.com)

- [Bridge Club Live](https://www.bridgeclublive.com/) offers a 30 day free trial.

- [Cardzmania](https://www.cardzmania.com/Bridge)

- Game Zone

- [Floater](https://sourceforge.net/projects/floaterbridge/)

- [PlayOK](https://www.playok.com/en/bridge/) (formerly known as Kurnik)

- Rubber and Duplicate Bridge games are included in the [Favorite Games](https://www.favorite-games.com/htmlen/downloads.php?id=42) Ltd. package.

- [Nidink](https://www.nidink.com/)

- [Tabletopia](https://tabletopia.com/games/contract-bridge)

- At Pierre-Marie Petit's [Jeubridge](https://www.jeubridge.com/) site (French language) you can play Bridge tournament deals on line.
...
Neural Play has produced a [Bridge app for Android](https://play.google.com/store/apps/details?id=com.neuralplay.android.bridge&hl=en).

[Funbridge](https://funbridge.com) is a bridge app for iPhone, iPad, Mac, Windows PC, Android and Amazon.You are South, and the other three hands are bid and played by the AI. You can compare your results with those of other users, and you can challenge a friend to a match in which you each play the same deals with the same cards. There is a choice of bidding systems and tournament formats.

Norm Radder's [improved version of Stephen Han's EasyBridge program](https://boardgamegeek.com/filepage/13285/freeware-easy-bridge-software) is available free from BoardGameGeek.

With [SimiliBridge](https://vincent-brevart.fr/en/bri/bridge-free-card-game.html), a free computer program for Windows, by Vincent Brévart, you can play either Minibridge or a full version of Bridge (with 5-card major bidding system) against the computer.

Special K Software has software to play the card games of Bridge. This software is available at [www.specialksoftware.com](https://www.specialksoftware.com).

From Dave Cullen's [Acol Bridge](http://www.acolbridge.co.uk) site you can download WolfBridge, a freeware Bridge program for Windows.

### Other WWW pages with useful Bridge links

The [American Contract Bridge League](https://www.acbl.org/) has many useful resources and links.

Jude Goodwin-Hanson maintains a page of [Great Bridge Links](https://greatbridgelinks.com/)

[ECats Bridge](https://www.ecatsbridge.com)

### Bridge Equipment Suppliers, Clubs and other Bridge related pages

The [Baron Barclay Bridge Supplies](https://baronbarclay.com) site has an on-line catalog of their equipment and links to other Bridge pages.

[Master Point Press](https://masterpointpress.com) is a publisher specialising in Bridge books.

The [Mindracer](http://www.mindracer.com) site has a range of Bridge products and a bidding quiz.

First for Bridge offers a range of [Bridge Holidays](https://www.firstforbridge.co.uk).
...
Home Page > Classified Index > Trick Taking Games > Auction Whist Group > Bridge
