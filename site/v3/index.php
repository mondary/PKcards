...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=Permanent+Marker&family=Space+Grotesk:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
...
.topfix__inner{max-width:1440px;margin:auto}.brandrow{display:flex;align-items:center;gap:12px}.brand{font:600 .68rem var(--mono)}.brand b{color:var(--pink);font-size:.9rem}.brand .ver{margin-left:8px;color:#aaa;font-size:.56rem}.spacer{flex:1}
.iconbtn{position:relative;padding:8px 10px;border:0;border-radius:4px;background:transparent;color:#fff;font:600 .64rem var(--mono);text-transform:uppercase;transition:background .15s,color .15s}.iconbtn:hover{background:var(--yellow);color:var(--ink)}.dot{margin-left:4px;color:var(--yellow)}
...
.list{padding:0 clamp(10px,3.4vw,52px) 96px}.game{display:grid;grid-template-columns:56px minmax(0,1fr) auto;align-items:center;min-height:94px;padding:0 12px;border-radius:4px;transition:background .15s,color .15s}.game:nth-child(4n+1):hover{background:var(--pink)}.game:nth-child(4n+2):hover{background:var(--blue);color:#fff}.game:nth-child(4n+3):hover{background:var(--yellow)}.game:nth-child(4n):hover{background:var(--mint)}.game__index{font:700 .65rem var(--mono);color:var(--blue);font-variant-numeric:tabular-nums}.game__main{min-width:0;padding:16px 12px}.game__title{display:block;font-size:clamp(1.1rem,2vw,1.5rem);font-weight:700}.game__sub,.game__meta{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.game__sub{margin-top:5px;color:var(--muted);font:.7rem var(--mono)}.game__meta{margin-top:7px;color:var(--muted);font-size:.7rem}.game:hover .game__sub,.game:hover .game__meta{color:inherit}.game__fav{min-width:48px;min-height:44px;border:0;border-radius:3px;background:transparent;color:inherit;font:700 .62rem var(--mono);text-transform:uppercase}.game__fav:hover,.game__fav.on{background:var(--ink);color:var(--yellow)}
.families{padding:28px clamp(18px,4vw,64px) 120px}.families__title{margin-bottom:38px;font:2.4rem var(--display);text-transform:uppercase}.families__grid{display:grid;grid-template-columns:repeat(3,1fr);gap:48px}.family{min-height:150px}.family__name{display:inline-block;padding:4px 8px;background:var(--pink);font:700 .68rem var(--mono);text-transform:uppercase;transform:rotate(-2deg)}.family:nth-child(2) .family__name{background:var(--blue);color:#fff;transform:rotate(2deg)}.family:nth-child(3) .family__name{background:var(--yellow)}.family__members{display:flex;flex-direction:column;margin-top:18px}.family__link{padding:6px 0;color:var(--muted);font-size:.88rem}.family__link:hover{color:var(--blue)}
...
@media(max-width:760px){
  ...
  .launcher{display:block;padding-top:54px}.launcher::after{left:auto;right:18px;top:28px;font-size:.9rem}.launcher h1{font-size:clamp(4.3rem,21vw,6.2rem);text-shadow:3px 3px 0 var(--pink),6px 6px 0 var(--blue)}.launcher__intro>p:last-child{margin:30px 0 34px}.search input{height:62px;box-shadow:5px 5px 0 var(--blue)}.chips{margin:26px -18px 0;padding:0 18px}.chip,.random{min-height:44px}.launcher__actions{justify-content:space-between}
