...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=DM+Mono:wght@400;500&family=IBM+Plex+Mono:wght@400;500;600&family=Outfit:wght@400;500;600;700&family=Permanent+Marker&family=Space+Grotesk:wght@400;500;600;700&display=swap" rel="stylesheet">
...
.theme-switch{display:flex;gap:3px}.theme-switch button{min-height:34px;padding:0 8px;border:0;border-radius:3px;background:rgba(255,255,255,.08);color:inherit;font:700 .58rem var(--mono)}.theme-switch button[aria-pressed="true"]{background:var(--pink);color:var(--ink)}
...
@media(max-width:760px){
  .brandrow{min-width:0;gap:6px}.brand{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.64rem}.brand .ver{display:none}.iconbtn{min-height:44px;flex:none;padding:7px;font-size:.62rem}.theme-switch{gap:2px}.theme-switch button{min-height:40px;padding:0 6px;font-size:.52rem}
  ...
  <div class="reader" data-prev="<?= e($prevSlug) ?>" data-next="<?= e($nextSlug) ?>">
    <div class="bar">
      ...
      <div class="theme-switch" role="group" aria-label="Choisir le thème">
        <button type="button" data-theme-set="cat">CAT</button><button type="button" data-theme-set="ascii">ASCII</button><button type="button" data-theme-set="graffiti">GRAFF</button>
      </div>
...
function syncThemeUI(){
  ...
  document.querySelector('meta[name="theme-color"]').content={cat:'#303446',ascii:'#11130f',graffiti:'#151515'}[currentTheme()] || '#303446';
}
